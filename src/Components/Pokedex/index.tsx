...
import { PokemonList, PokemonTypeProps } from '../PokemonList';
...
export const Pokedex = () => {
  ...
  //FAZ REQUEST DOS TIPOS DE POKEMONS DA API E GUARDA, USANDO O PROPS ACIMA
...
//FAZ A REQUISIÇÃO DOS POKEMONS, COM PAGE-SIZE E OFFSET, FORMATA OS DADOS
...
//PEGA O POKEMON CLICADO E SETTA TRUE O MODAL
...
//ESCUTA A SEARCHBAR E FAZ REQUISIÇÃO
...
//---------------------------------------------------------------------------------
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const scrollPositionToLoad = innerHeight + scrollY >= offsetHeight - 100;

      if (scrollPositionToLoad) {
        handleLoadMore();
      }
    };
          ...
          <SimpleGrid columns={[1, null, 2, 3]} spacing={[0, null, '34px']}>
            {searchValue === '' ? (
              pokemonList.map((pokemon: PokemonTypeProps, index: number) => (
                <PokemonList key={index} {...pokemon} onClick={() => handlePokemonClick(pokemon)} />
              ))
            ) : (
            ...
            <>
              ...
              <ModalBody className={selectedPokemon.types.includes('grass') || selectedPokemon.types.includes('bug') ? styles.modal_body_green :
                ...
                <section className={styles.modal_container}>
                  ...
                  <div className={selectedPokemon.types.includes('grass') || selectedPokemon.types.includes('bug') ? styles.modal_image_container_green :
                  ...
                  <div className={styles.modal_information_container}>
                    <div className={styles.information_header}>
                      ...
                      <div className={styles.generation_container}>
